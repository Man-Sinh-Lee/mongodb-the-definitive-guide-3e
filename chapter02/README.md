### Chapter 2: Getting Started - Detailed Summary with Examples
...
##### A MongoDB Client
The `mongo` shell acts as a MongoDB client, providing the `db` object to interact with the connected database. For instance, to see the current database:
